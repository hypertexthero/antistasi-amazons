...
SDKFlag = "Flag_FIA_F";
SDKFlagTexture = "flag.jpg"; if (isServer) then {flagX setFlagTexture SDKFlagTexture}; // https://a3antistasi.enjin.com/forum/m/38173738/viewthread/33064918-custom-flag-texture?set-browser-type=web
...
//Starting Unlocks
initialRebelEquipment append ["hgun_Pistol_heavy_02_F","hgun_ACPC2_F","hgun_PDW2000_F","arifle_TRG21_MRCO_F"];
initialRebelEquipment append ["hgun_PDW2000_F","arifle_TRG21_MRCO_F"];
initialRebelEquipment append ["6Rnd_45ACP_Cylinder","9Rnd_45ACP_Mag","30Rnd_9x21_Mag","30Rnd_556x45_Stanag_Tracer_Green","MiniGrenade","SmokeShell","optic_MRCO"];
